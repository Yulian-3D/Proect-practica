        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Price = table.Column<int>(type: "INTEGER", nullable: false),
                    TradeCreateDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    TradeConfirmationDate = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsConfirmed = table.Column<bool>(type: "INTEGER", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ItemTrades", x => x.Id);
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_ItemTrades_Users_BuyerUserId",
                        column: x => x.BuyerUserId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ItemTrades_Users_SellerUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemTrades_BuyerUserId",
                table: "ItemTrades",
                column: "BuyerUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemTrades_SellerUserId",
                table: "ItemTrades",
                column: "SellerUserId");
